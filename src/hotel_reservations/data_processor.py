...
class DataProcessor:
    ...
    def enable_change_data_feed(self) -> None:
        ...
        """
        self.spark.sql(
            f"ALTER TABLE {self.config.catalog_name}.{self.config.schema_name}.train_set_hotel"
            "SET TBLPROPERTIES (delta.enableChangeDataFeed = true);"
        )

        self.spark.sql(
            f"ALTER TABLE {self.config.catalog_name}.{self.config.schema_name}.test_set_hotel"
            " SET TBLPROPERTIES (delta.enableChangeDataFeed = true);"
        )
